...
export const HeroContent = () => {
  return (
    <div className="relative box-border max-w-screen-lg min-h-[auto] min-w-[auto] text-center z-10 mx-auto px-6">
      <div 
        className="text-white text-2xl sm:text-3xl box-border tracking-[-1.2px] leading-[1.1] uppercase mb-4 md:text-5xl md:tracking-[-2.4px] md:leading-[60px] opacity-0 animate-fade-in-down"
      >
        The Creative Engine
      </div>
      <h1 
      ...
      <p 
        className="text-white text-lg sm:text-xl box-border leading-7 max-w-screen-md mb-8 mx-auto md:text-2xl md:leading-8 opacity-0 animate-fade-in-up animation-delay-400"
      >
